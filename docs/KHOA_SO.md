...
| khoản | số lượng |
|---|---|
| Cấu hình **mô hình** đã thử trên tập phát triển | **~1.318** (685 đến 08/09 + 580 bổ sung 09–11/09 + 7 dòng 42 + 7 dòng 43 + 5 dòng 44 + 4 dòng 45 + 2 dòng 46 + **8 dòng 47**) + **5 dòng 48** | + 9 dòng 49 + **6 dòng 50** |
